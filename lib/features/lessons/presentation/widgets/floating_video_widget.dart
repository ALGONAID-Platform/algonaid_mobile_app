      ...
      child: GestureDetector(
        ...
        onScaleUpdate: (details) {
          setState(() {
            ...
            _yOffset = _yOffset.clamp(30.0, screenHeight - _height - 30.0); // 30 padding for safe area
            _updatePipRect();
          });
        },
        child: Material(
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                  ...
                  child: GestureDetector(
                    onTap: () {
                      setState(() {}); // Trigger rebuild to remove from tree before destroying
