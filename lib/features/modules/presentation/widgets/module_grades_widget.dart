...
class ModuleGradesWidget extends StatefulWidget {
  ...
  const ModuleGradesWidget({super.key, required this.moduleId});

  @override
  State<ModuleGradesWidget> createState() => _ModuleGradesWidgetState();
}

class _ModuleGradesWidgetState extends State<ModuleGradesWidget> {
  late ModuleGradesProvider _provider;
    ...
    return ChangeNotifierProvider.value(
      ...
      child: Consumer<ModuleGradesProvider>(
        builder: (context, provider, child) {
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      ' لا توجد اختبارات لهذه الوحدة بعد، كلما قمت بإنجاز اختبار سيتم عرض درجتك ونتيجتك هنا بالتفصيل.',
          ...
          final isUnlocked = grades.averagePercentage >= 85;
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                isUnlocked ? 'رائع! لقد تم فك قفل وسام البراعة.' : 'تحتاج إلى 85% لفتح الوسام.',
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          onTap: () {
                            ...
                            GoRouter.of(context).push(targetRoute, extra: '${Routes.lessonsList}/${widget.moduleId}');
                          },
